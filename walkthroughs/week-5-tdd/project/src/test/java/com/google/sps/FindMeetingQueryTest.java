...
public final class FindMeetingQueryTest {
    ...
    public void everyAttendeeIsConsideredIgnoreOptional() {
        // Have one optional person C. Have each person have different events. We should see 
        // three options if C is not invited.
        //
        // Events  :       |--A--|     |--B--|
        //           |--------------C--------------|
        // Day     : |-----------------------------|
    ...
    public void everyAttendeeIsConsideredIncludeOptional() {
        // Have one optional person C. Have each person have different events. We should see two 
        // options since we take C into consideration.
        // Events  :       |--A--|     |--B--|
        //                       |--C--|
        // Day     : |-----------------------------|
        // Options : |--1--|                 |--3--|
    ...
    public void justEnoughRoomIgnoreOptional() {
        // Have one optional person B, ignore B since otherwaise there would be no avaible time slot.
        //
        // Events  : |--A--|     |----A----|
        //                 |-B|
        // Day     : |---------------------|
    ...
    @Test
    public void justEnoughRoomOnlyOptional() {
        // Have two optional person, return gaps in there schedule that satisfy meeting duration.
        //
        // Events  :    |--A--| |--B--|
        // Day     : |---------------------|
        // Options : |--|     |-|     |----|
